...
```{r, out.width="95%"}
knitr::include_graphics("figures/triple.svg")
```
...
```{r}
knitr::include_graphics("../paper2-PRS/figures/pres-AUC-logit.svg")
```
...
```{r}
knitr::include_graphics("../paper2-PRS/figures/pres-AUC-PRS.svg")
```
...
```{r, out.width="90%"}
knitr::include_graphics("../paper2-PRS/figures/pres-ttrees.svg")
```
...
```{r, out.width="90%"}
knitr::include_graphics("../paper2-PRS/figures/pres-triple.svg")
```
...
```{r}
knitr::include_graphics("../paper2-PRS/figures/pres-AUC-ntrain.svg")
```
...
```{r}
knitr::include_graphics("../paper2-PRS/figures/pres-AUC-chr6.svg")
```

...
```{r}
knitr::include_graphics("figures/fig-GWAS-C+T.png")
```
--
```{r}
knitr::include_graphics("figures/fig-GWAS-C+T-clumping.png")
```
--
```{r}
knitr::include_graphics("figures/fig-GWAS-C+T-clumping-thresholding.png")
```

...
--
3. Extending the set of parameters tested in C+T (implemented in bigsnpr) to achieve higher predictive performance with C+T. Extension via stacking. Comparison with lassosum and LDpred.

    (https://doi.org/10.1101/653204)

---

background-image: url("figures/flag-denmark.png")
background-size: cover

### Current work in Denmark

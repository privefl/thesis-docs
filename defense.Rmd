...
- currently: 500K x 800K, [UK Biobank](https://doi.org/10.1101/166298) (~2.9TB)
...
```{r, out.width='85%'}
knitr::include_graphics("figures/table-bench-simple.png")
```
...
The idea of LDpred, lassosum and the other methods is to use a reference panel to **account for correlation** between variants, instead of pruning (removing) variants.

...
The idea of LDpred, lassosum and the other methods is to use a reference panel to **account for correlation** between SNPs, instead of pruning (removing) SNPs. Lassosum also adds some sparsity.
...
- support other formats than PLINK bed files?    
(imputation probabilities / dosages)

--

- do they have a scalable implementation?

--

<br>

We decided to improve C+T first.
...
## Data (real summary statistics and phenotypes)
...
- Answering reviews for C+T/SCT paper (due for 30 Sept)
...
- comparison of PRS models with models based on clinical & environmental factors

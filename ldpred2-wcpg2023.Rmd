...
- We worked on properly validating the inference of $h^2$, $p$, and $\alpha$ (and their CIs) using extensive simulations.

- We also showed that LDpred2-auto provides calibrated per-variant probabilities of being causal.

- We introduced a formula to infer the out-of-sample predictive performance $r^2$ directly from the Gibbs sampler.

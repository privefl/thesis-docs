...
- use floats instead of double for parameters (speed x2!?)
...
- They looked at different LD matrices and their spectral distribution
...
- I think int8-quantization is too much, but int16 takes 6x more space (because of less efficient compression I guess)

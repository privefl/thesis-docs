...
- Instead of picking L initial $PC_{l,.}^{\text{ref}}$ at random,    
I start with 2 reference populations using 1 PC,    
and iteratively add one more reference (L+1) with each new PC (K+1)   (with good starting values, and 2 refs for 1 PC)

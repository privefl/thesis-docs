...
- If $n$ is not to large (say $n < 10,000$), you can use the eigen decomposition from $X X^T$ (an $n \times n$ matrix). It is impossible to do it with $X^T X$ because $p$ is too large.
...
talk about linear algebra tricks? bof
...
## Filtering on univariate statistics?

How to show that this is sub-optimal?
...
Different regularizations can be used to prevent overfitting, among other benefits: 

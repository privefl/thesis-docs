...
I can use the previous formula to find the regularization that minimizes $|z_t - \tilde{z}_t|$.
...
- Test something else? 
    - E.g. compare likelihoods of models with and without the variant? For all other correlated variants?
...
Presentation available at https://privefl.github.io/thesis-docs/qc-sumstats3.html

...
When you have only summary statistics (and a small reference panel):
...
The idea of LDpred and lassosum is to use a reference panel to **account for correlation** between SNPs, instead of pruning (removing) SNPs. Lassosum also adds some sparsity.

...
- reimplemented in our R package {bigstatsr} that uses memory-mapping to matrices stored on disk
...
Let us focus on the choice of the hyper-parameter $\lambda$ and how it can make our algorithm faster.
...
- logit-simple: penalized logistic regression with auto $\lambda$

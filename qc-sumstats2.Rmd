...
GCTA method for the quality control of GWAS summary statistics, by comparing Z-scores with imputed Z-scores using nearby variants.
...
- 3663 true positives (TP, real errors) and 4651 false positives (FP)    
with DENTIST

- 3349 TP and 19 FP    
with my alternative reimplementation
...
- 12,310 "errors" detected with DENTIST

- 4529 "errors" detected with my current methodology
...
### At least two issues with the imputation model

...
<u><b>Interdisciplinary work:</b></u> 
...
- 11 first-author publications, mostly published in 

    - *Bioinformatics* (x5)
    - *American Journal of Human Genetics (AJHG)* (x3)

- 28 publications with 2850+ citations in total,    
including **2000+ for my 11 first-author papers**

- maintaining 13 R packages on CRAN (+ 2 more incoming)

---

### Scientific communication, animation and international visibility
...
- reviewer for 
    ...
    - 62 manuscripts across 31 journals

    - Amsterdam UMC Fellowship 2022
    
    - EMGM Brest 2025 (member of the Scientific Committee)

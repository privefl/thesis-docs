...
- two new versions:
    ...
    - an 'auto' option, which can infer the two hyper-parameters of the Bayesian model: the polygenicity $p$ and the SNP-heritability $h^2$
    
- post-hoc quality control of Gibbs sampler chains

---

### GWAS summary statistics and robustness
...
2. The IAB, Institute for Advanced Biosciences (INSB, UMR 5309)

3. The LJK, Jean Kuntzmann Laboratory (INSMI, UMR 5224)

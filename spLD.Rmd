...
With $\lambda_\text{min}$ as the smallest eigenvalues for $R$, we can use $s = \frac{\epsilon - 1}{\lambda_\text{min} - 1}$ to get $\epsilon$ as the smallest eigenvalue for $R_s$.

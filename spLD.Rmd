...
### How to use even more variants? (1/)

By being more stringent in the block splitting (i.e. making smaller blocks), we can reduce the size by 50%. It also makes LDpred2 more robust, but also reduces its predictive performance when robustness is not an issue.
...
### Use very sparse of the LD matrix?

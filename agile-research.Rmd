...
A bit of background to understand where this talk is coming from:
...
$\Rightarrow$ How to turn an idea into reality?
...
$\Rightarrow$ How to turn an idea into a paper?
...
(I usually define my sprints as less than one day when possible,    
but it can also be a whole week for longer tasks).

--

- Once you start a sprint, you should try to **focus** only on this, until completion.

--

- It is important to always set a **maximum time limit** for a sprint. 
...
Everyday, in 5-10 minutes, everyone presents 

- what they have been working on

- what they will be working on (e.g. planning the sprint of the day)
...
- Design small tasks that you can do quickly (sprints)

--

- For exploratory analyses, determine a time limit beforehand 
...
- Agile is a tried-and-tested method in the Industry.
...
Some inspiration from *Agile Data Science with R: a workflow* by Edwin Thoen (https://edwinth.github.io/ADSwR/)

...
$$L(Q, F) = \sum_i \sum_j \left\{ G_{ij} \log\left[\sum_l Q_{il} F_{lj}\right] + (2 - G_{ij}) \log\left[\sum_l Q_{il} (1 - F_{lj})\right] \right\}$$
with constraints: $~0 \le F_{lj} \le 1~$ and $~Q_{il} \ge 0~$ and $~\sum_l Q_{il} = 1$
...
[SHOULD PROBABLY SPLIT THIS IN THREE]

--

***

Optimization method: iterate between 

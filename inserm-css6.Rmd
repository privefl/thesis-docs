...
- variants can be aggregated in a joint predictive model: $PRS = \sum_j \hat\gamma_j~G_j$
    ...
    $\Rightarrow$ the $PRS$ has a much larger effect size than any $G_j$  
...
<u>Traditional risk factors</u>: age, smoking, pollution, low SES, diet, physical inactivity, family history, (low-frequency high-impact) genetic mutations, etc

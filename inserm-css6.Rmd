...
### Modification of breast cancer risk using a PRS (of 86 variants)
...
The issue: we often don't use causal variants in practice 
...
### WP1 and WP4 to ensure causal variants are in the input data
